...
public class DebugExercise2 {
    ...
    /**
     * Returns a new array where entry i is the max of a[i] and b[i]. For
     * example, if a = {1, -10, 3} and b = {0, 20, 5}, this function will
     * return {1, 20, 5}.
     */
    ...
    /**
     * Returns the sum of the element-wise max of a and b. For example if a =
     * {2, 0, 10, 14} and b = {-5, 5, 20, 30}, the result should be 57.
     */
